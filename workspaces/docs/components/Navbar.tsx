...
export function Navbar({ onMenuPress }: { onMenuPress?: () => void }) {
	...
	return (
		...
		>
			...
			{/* Center nav — always visible on non-mobile */}
			{!isMobile && (
			...
			<View style={styles.navRight}>
				...
				<Pressable
					onPress={() =>
						Platform.OS === 'web'
							? (window as Window).open('https://www.npmjs.com/package/react-native-cross-elements', '_blank')
							: undefined
					}
					style={({ pressed, hovered }) => [
				...
				<Pressable
					onPress={() =>
						Platform.OS === 'web'
							? (window as Window).open('https://github.com/imroodydev/react-native-cross-elements', '_blank')
							: undefined
					}
					style={({ pressed, hovered }) => [
						styles.headerActionBtn,
